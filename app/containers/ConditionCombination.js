...
import {
  ...
  AddOperation,
  AddCondition
} from './../actions/ConditionActionCreater';
import {
  PrepareQuertyStatement,
  IncreaseConditions,
  DecreaseConditions
    ...
    return (
      <div>
        <FormControl className={classes.formControl}>
          ...
          <Select
            value={
              this.props.conditionReducer.filterByCondtion[this.props.id] !==
              undefined
                ? this.props.conditionReducer.filterByCondtion[this.props.id]
                    .filterBy
                : ''
            ...
            onChange={event => {
              this.props.AddFilterBy(
                this.props.conditionReducer.filterByCondtion,
                this.props.id,
                event.target.value
              );
              //const newState = {...props.queryReducer, columns: event.target.value}
              this.props.PrepareQuertyStatement(
                this.props.queryReducer,
                this.props.conditionReducer
              );
            }}
            inputProps={{
              name: 'filterBy',
        ...
        <FormControl className={classes.formControl}>
          ...
          >
            {this.props.operation !== undefined
              ? this.props.operation.map((val, index) => (
                  <MenuItem key={index} value={val}>
                    {val}
                  </MenuItem>
                ))
